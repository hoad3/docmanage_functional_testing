describe("module2-2: Chỉnh sửa tên của một tài liệu ", () => {
  before( async () =>{
    await browser.maximizeWindow();
    await module1_5();
  })

  it("Chỉnh sửa tên của một tài liệu thành công", async () => {
    ...
    await browser.$("[name='fileName']").doubleClick();
    await browser.pause(1000)

    //Nhấn backspace để xóa tên trước đó 
    await browser.keys('\uE003');

    await browser.pause(1000)

    await browser.$("[name='fileName']").setValue("đổi tên")
